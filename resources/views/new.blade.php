...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
   ...
   <!-- section -->
    ...
    <script src="assets/assets/js/jquery.pogo-slider.min.js"></script>
    <script src="assets/assets/js/slider-index.js"></script>
    ...
    <script src="assets/assets/js/images-loded.min.js"></script>
